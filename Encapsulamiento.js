...
*/
var Smartphone2 = /** @class */ (function () {
    function Smartphone2(color, marca) {
        this.color = color;
        this.marca = marca;
        this._bateria = 100; // lo incializamos directamente porque es opcional        
    }
    Smartphone2.prototype.makeApthoneCall = function () {
        if (this._bateria === 0) {
    ...
    Smartphone2.prototype.recharge = function () {
        this._bateria = 100;
    };
    return Smartphone2;
}());
var obj2 = new Smartphone2('Negro', 'Iphone');
